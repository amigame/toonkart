...
var config = {
	...
	js: {
		...
		paths: {
			...
			'handlebars': '//cdnjs.cloudflare.com/ajax/libs/handlebars.js/2.0.0/handlebars.min.js',
	...
	/*
	{
		...
		paths: {
			...
			json3: [
				"//cdnjs.cloudflare.com/ajax/libs/json3/3.3.2/json3.min"
			],
			jquery: [
